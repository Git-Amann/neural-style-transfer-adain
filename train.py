...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='C:/Users/triac/OneDrive/Desktop/NST_project/content_data',
                    help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='C:/Users/triac/OneDrive/Desktop/NST_project/style_data',
                    help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='C:/Users/triac/OneDrive/Desktop/NST_project/vgg_normalised.pth',
